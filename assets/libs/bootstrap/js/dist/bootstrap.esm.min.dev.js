    ...
    if (!(this._element.disabled || this._element.classList.contains(CLASS_NAME_DISABLED) || this._menu.classList.contains(CLASS_NAME_SHOW$1))) {
      ...
      if (!EventHandler.trigger(this._element, EVENT_SHOW$1, n).defaultPrevented) {
        if (!this._inNavbar) {
          ...
          var i = this._element;
          "parent" === this._config.reference ? i = e : isElement(this._config.reference) && (i = this._config.reference, void 0 !== this._config.reference.jquery && (i = this._config.reference[0])), this._popper = (0, Popper.createPopper)(i, this._menu, this._getPopperConfig());
        }
...
var NAME$6 = "tooltip",
  ...
  return n.enable = function () {
    ...
    if (this.isWithContent() && this._isEnabled) {
      ...
      Data.setData(o, this.constructor.DATA_KEY, this), this._element.ownerDocument.documentElement.contains(this.tip) || l.appendChild(o), EventHandler.trigger(this._element, this.constructor.Event.INSERTED), this._popper = (0, Popper.createPopper)(this._element, o, this._getPopperConfig(s)), o.classList.add(CLASS_NAME_SHOW$3);
